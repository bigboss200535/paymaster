...
<!-- ----------------------------Menu------------------------------------------------------ -->
    ...
    <!-- <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div class="text-truncate" data-i18n="Users">Application</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ url('applications') }}" class="menu-link">
            <div class="text-truncate" data-i18n="List">Applicants</div>
          </a>
        </li>
         <li class="menu-item">
          <a href="/employees" class="menu-link">
            <div class="text-truncate" data-i18n="List">Interviews</div>
          </a>
        </li>
      </ul>
    </li> -->
...
<!-- -----------------------------------employee------------------------------------------------- -->
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div class="text-truncate" data-i18n="Users">Employee</div>
      ...
      <li class="menu-item">
        ...
        <!-- <li class="menu-item">
          <a href="{{ url('addemployee') }}" class="menu-link">
