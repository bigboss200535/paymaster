      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Product Name" name="productTitle" aria-label="Product title">
          </div>
          <div class="row mb-3">
            <div class="col"><label class="form-label" for="product_description">Description</label>
              <input type="text" class="form-control" id="product_description" name="product_description" placeholder="Other Descrption" name="productSku" aria-label="Product SKU"></div>
            <div class="col"><label class="form-label" for="manufacturer">Manufacturer</label>
            
              <input type="text" class="form-control" id="manufacturer" name="manufacturer" placeholder="0123-4567" name="productBarcode" aria-label="Product barcode"></div>
          </div>
          <div class="row mb-3">
            <div class="col"><label class="form-label" for="category">Category</label>
            ...
            <div class="col"><label class="form-label" for="sales_type">Sales Type</label>
      ...
      <div class="card mb-4">
        <div class="card-body">
          <div class="mb-3 col ecommerce-select2-dropdown">
            ...
            <select id="expirable" name="expirable" class="select2 form-select" data-placeholder="Select Vendor">
              <option value="" disabled selected>-Select-</option>
          ...
          <div class="mb-3 col ecommerce-select2-dropdown">
            ...
            <select id="stockable" name="stockable" class="select2 form-select" data-placeholder="Select Vendor">
              <option value="" disabled selected>-Select-</option>
          ...
          <div class="mb-3 col ecommerce-select2-dropdown">
            ...
            <select id="status" name="status" class="select2 form-select" data-placeholder="Select Category">
